...
import getSettingsData from "../../controllers/settings/GET/getSettingsData";
import patchUserPassword from "../../controllers/settings/PATCH/patchUserPassword";
import patchUserEmail from "../../controllers/settings/PATCH/patchUserEmail";
